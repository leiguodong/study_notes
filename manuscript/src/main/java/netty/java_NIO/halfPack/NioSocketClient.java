package netty.java_NIO.halfPack;
...
public class NioSocketClient extends Thread {
    ...
    public void send(SelectionKey key) {
        ...
        for (int i = 0; i < 10; i++) {
            String ss = i + "Server ,how are you? this is package message from NioSocketClient!Server ,how are you? this is package message from NioSocketClient!";
